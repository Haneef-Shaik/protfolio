...
export default function About() {
  ...
  return(
    <div className="w-full min-h-screen bg-[#262626] grid md:grid-cols-2 h-full">
    <FadeIn>
    <div className="grid items-center p-4 h-full" >
      <div className="relative rounded-xl p-0.5 overflow-hidden" style={{zIndex:0}} >
        <div className={`${styles.card_rotator} `} ></div>
      <div className={`${styles.neomorpichBox} p-4 rounded-xl flex flex-col gap-6 w-full`} >
      <div className="text-center text-2xl md:text-4xl font-bold text-[#cccccc]" >About Me</div>
